                ...
                <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-lg p-6">
                    <div>
                        ...
                        @if($ultimaCompra)
                            ...
                            <p class="text-gray-800 text-sm mt-1">{{ $ultimaCompra->created_at->format('d \\d\\e F \\d\\e Y - H:i') }}</p>
                        @else
                                    ...
                                    <div class="border rounded-lg p-4 hover:bg-gray-50 transition">
                                        <div class="flex justify-between items-start mb-2">
                                            <div>
                                                ...
                                                <p class="text-sm text-gray-500">{{ $compra->created_at->format('d \\d\\e F \\d\\e Y - H:i') }}</p>
                                            </div>
